...
import { getCabinCount } from '../_lib/data-service';

export const revalidate = 0; // seconds to regenerate the page
...
export default async function Page() {
    ...
    return (
        <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
            {/* <div className='col-span-5 relative  items-center justify-center'>
                <div className='h-full w-full'>
                    <p className='text-xl text-primary-200'>
                        Here should be a spinner
                    </p>
                    <Spinner />
                </div>
            </div> */}
            <div className='col-span-3'>
                ...
                <div className='space-y-8'>
                    ...
                    <p>
                        Our {count} luxury cabins provide a cozy base, but the
